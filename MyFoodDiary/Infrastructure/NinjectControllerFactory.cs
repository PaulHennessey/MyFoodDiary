...
namespace MyFoodDiary.Infrastructure
{
    public class NinjectControllerFactory : DefaultControllerFactory
    {
        ...
        private void AddBindings()
        {
            ...
            ninjectKernel.Bind<IProductRepository>().To<ProductRepository>().WithConstructorArgument("connectionString", ConfigurationManager.ConnectionStrings["MyFoodDiary_ConnectionString"].ConnectionString);
            ...
            ninjectKernel.Bind<IIngredientRepository>().To<IngredientRepository>().WithConstructorArgument("connectionString", ConfigurationManager.ConnectionStrings["MyFoodDiary_ConnectionString"].ConnectionString);
        }
    }
}